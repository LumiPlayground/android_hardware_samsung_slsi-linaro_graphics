...
const exynos_mpp_t AVAILABLE_OTF_MPP_UNITS[] = {
    ...
    {MPP_DPP_VG, MPP_LOGICAL_DPP_VG, "DPP_VG1", 1, 0, HWC_DISPLAY_EXTERNAL_BIT|HWC_DISPLAY_VIRTUAL_BIT},
    {MPP_DPP_VGF, MPP_LOGICAL_DPP_VGF, "DPP_VGF0", 0, 0, HWC_DISPLAY_PRIMARY_BIT},
    {MPP_DPP_VGF, MPP_LOGICAL_DPP_VGF, "DPP_VGF1", 1, 0, HWC_DISPLAY_EXTERNAL_BIT|HWC_DISPLAY_VIRTUAL_BIT}
};

const exynos_mpp_t AVAILABLE_M2M_MPP_UNITS[] = {
    {MPP_MSC, MPP_LOGICAL_MSC, "MSC0_PRI", 0, 0, HWC_DISPLAY_PRIMARY_BIT},
    {MPP_MSC, MPP_LOGICAL_MSC_YUV, "MSC0_EXT", 0, 1, HWC_DISPLAY_EXTERNAL_BIT|HWC_DISPLAY_VIRTUAL_BIT},
    {MPP_G2D, MPP_LOGICAL_G2D_YUV, "G2D0-YUV_EXT", 0, 1, HWC_DISPLAY_EXTERNAL_BIT|HWC_DISPLAY_VIRTUAL_BIT},
    {MPP_G2D, MPP_LOGICAL_G2D_RGB, "G2D0-RGB_EXT", 0, 3, HWC_DISPLAY_EXTERNAL_BIT|HWC_DISPLAY_VIRTUAL_BIT},
};
...
const exynos_display_t AVAILABLE_DISPLAY_UNITS[] = {
    ...
    {HWC_DISPLAY_EXTERNAL, 0, "ExternalDisplay", "/dev/graphics/fb2", "12a40000.decon_t/vsync"},
